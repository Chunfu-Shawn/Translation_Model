...
from model.translation_base_model_adaLN import TranslationBaseModel
...
base_model = TranslationBaseModel.from_config("config/base_model_v3_384d_8h_10l_4c.yaml").cuda(rank)
