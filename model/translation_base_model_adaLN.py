...
from model.model_modules import LinearEmbedding, AdaEncoder, AdaEncoderLayer
...
class TranslationBaseModel(nn.Module):
    ...
    def __init__(
        ...
        encoder_layer = AdaEncoderLayer(d_model, d_ff, n_heads, p_drop, self.num_cells)
        self.encoder = AdaEncoder(encoder_layer, number_of_layers, self.num_cells)
    ...
    def forward(
        ...
        **kwargs
        ...
        # encode (pass cell_type_idx for AdaLayerNorm)
        src_reps = self.encoder(src_embs, src_mask, cell_type_idx)
