...
from train.model_finetune_startstop_decoder import FineTuningTrainer
...
dataset_name = "datasets_1_cell_types_6k"
...
# "config/base_model_256d_8h_8l_1c_1drop.yaml"
lora_model = build_lora_model_from_pretrained(
    TranslationBaseModel.from_config("config/base_model_128d_4h_6l_1c_1drop.yaml"), 
    r=4, lora_alpha=16
    ).cuda(rank)
...
lora_model.load_pretrained_weights("../checkpoint/pretrain/base_model_128d_4h_6l_1c_1drop-MaskedDensityHead-MaskedCellTypeHead.0.01_0.001_0.3.best.pt")
