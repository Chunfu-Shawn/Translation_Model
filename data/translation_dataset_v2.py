...
class TranslationDataset(Dataset):
    ...
    def __init__(self, dataset_dict):
        ...
        self.te_scale = dataset_dict["te_scales"] # list of (L, 1)
            ...
            try:
                with h5py.File(path, "r") as f:
                    ...
                    for uuid in f["samples"].keys():
                        ...
                        data["te_scale"].append(np.int16(grp.attrs.get("te_scale", -1)))
                return cls(data)
            except FileNotFoundError:
                print(f"### Error: No such file: {path} ! ###")
        else:
    ...
    def __getitem__(self, idx):
        ...
        if getattr(self, "_lazy", False):
            ...
            te_scale = np.float32(grp.attrs.get('te_scale', None)) # (L, 1)
                                   
            return uuid, species, cell_type, expr_vector, meta_info, seq_emb, count_emb, te_scale
