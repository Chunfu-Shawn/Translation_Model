...
from model.coding_decoder import CodingDecoder
from model_finetune_startstop_decoder import FineTuningTrainer
...
lora_model.add_head(
    "coding",
    CodingDecoder.create_from_model(
        lora_model,
        d_output = 3,
        d_decoder = 128,
        n_heads = 4,
