...
from model.translation_base_model_no_self_attn import TranslationBaseModel
...
base_model = TranslationBaseModel.from_config("config/base_model_no_self_attn_384d_8h_10l_4c.yaml").cuda(rank)
